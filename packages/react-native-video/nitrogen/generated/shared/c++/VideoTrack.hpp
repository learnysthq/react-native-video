...
namespace margelo::nitro::video {
  ...
  /**
   * A struct which can be represented as a JavaScript object (VideoTrack).
   */
  struct VideoTrack {
  public:
  ...
  public:
    VideoTrack() = default;
    explicit VideoTrack(std::string id, double width, double height, double bitrate, bool selected): id(id), width(width), height(height), bitrate(bitrate), selected(selected) {}
  };
...
namespace margelo::nitro {
  ...
  // C++ VideoTrack <> JS VideoTrack (object)
  template <>
  struct JSIConverter<margelo::nitro::video::VideoTrack> final {
    static inline margelo::nitro::video::VideoTrack fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::video::VideoTrack(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::video::VideoTrack& arg) {

...
namespace margelo::nitro::video {
  ...
  /**
   * A struct which can be represented as a JavaScript object (AudioTrack).
   */
  struct AudioTrack {
  public:
  ...
  public:
    AudioTrack() = default;
    explicit AudioTrack(std::string id, std::string label, std::optional<std::string> language, double bitrate, bool selected): id(id), label(label), language(language), bitrate(bitrate), selected(selected) {}
  };
...
namespace margelo::nitro {
  ...
  // C++ AudioTrack <> JS AudioTrack (object)
  template <>
  struct JSIConverter<margelo::nitro::video::AudioTrack> final {
    static inline margelo::nitro::video::AudioTrack fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::video::AudioTrack(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::video::AudioTrack& arg) {
